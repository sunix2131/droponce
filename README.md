...
Важно: CloudPub token не должен попадать в GitHub или публичные чаты. Если токен уже был показан кому-то, лучше перевыпустить его в CloudPub dashboard.
...
Перед публичным распространением добавьте нужную лицензию.
